...
class GensimSummarisationTestCases(unittest.TestCase):
    ...
    gensim = summariser.get_summariser(params=summariser_params)

    def test_gensim_summary_manhattan_project_1(self):
        doc = self.whoosh.retrieve("The Manhattan Project?")[0].text
        summary = self.gensim.summarise(doc)[0].text

        self.assertGreater(len(summary), 0)
        self.assertLessEqual(len(summary), 1000)

    def test_gensim_summary_manhattan_project_2(self):
    ...
    def test_gensim_summary_manhattan_project_3(self):
    ...
    def test_gensim_summary_manhattan_project_4(self):
    ...
    def test_gensim_summary_manhattan_project_5(self):
    ...
    def test_gensim_summary_restorative_justice_1(self):
    ...
    def test_gensim_summary_restorative_justice_2(self):
    ...
    def test_gensim_summary_restorative_justice_3(self):
    ...
    def test_gensim_summary_restorative_justice_4(self):
    ...
    def test_gensim_summary_restorative_justice_5(self):
    ...
    def test_gensim_summary_immigration_1(self):
    ...
    def test_gensim_summary_immigration_2(self):
    ...
    def test_gensim_summary_immigration_3(self):
    ...
    def test_gensim_summary_immigration_4(self):
    ...
    def test_gensim_summary_immigration_5(self):
    ...
    def test_gensim_summary_medical_tourism_1(self):
    ...
    def test_gensim_summary_medical_tourism_2(self):
    ...
    def test_gensim_summary_medical_tourism_3(self):
    ...
    def test_gensim_summary_medical_tourism_4(self):
    ...
    def test_gensim_summary_medical_tourism_5(self):
